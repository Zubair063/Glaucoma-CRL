...
class CausalMultimodalModelViTBERT(nn.Module):
    ...
    def __init__(self, args):
        ...
        # ViT base outputs hidden_size=768, same as BERT base
        ...
        # For ViT: img_hidden_sz = 768, so if num_image_embeds=1, then img_feat_dim=768
        if img_feat_dim != d:
    ...
    def forward(self, txt, mask, segment, img, labels=None):
        """
        Forward pass with causal representation learning
