...
def get_args():
    parser = argparse.ArgumentParser(description="Train Causal Multimodal Model (VGG + DeBERTa) on FairCLIP")
    ...
    # Model arguments
    parser.add_argument("--deberta_model", type=str, default="microsoft/deberta-base",
                        help="DeBERTa model name")
    parser.add_argument("--vgg_variant", type=str, default="vgg16",
                        choices=["vgg11", "vgg13", "vgg16", "vgg19", "vgg11_bn", "vgg13_bn", "vgg16_bn", "vgg19_bn"],
                        help="VGG variant")
    parser.add_argument("--hidden_sz", type=int, default=768,
                        help="Hidden size (DeBERTa output dimension)")
    parser.add_argument("--img_hidden_sz", type=int, default=4096,
                        help="Image encoder hidden size (VGG outputs 4096)")
    ...
    parser.add_argument("--name", type=str, default="causal_vgg_deberta",
...
def main():
    ...
    # Create model
    logger.info("Creating model with VGG + DeBERTa...")
    model = CausalMultimodalModelVGGDeBERTa(args)
    model.cuda()
